...
pizzaJson.map((item, index) => {
    ...
    //  ========  preenchendo as informações do pizzaItem  ========

    pizzaItem.setAttribute('data-key', index) 
    // adiciona as pizza um chave pra poder usar ela tanto no modal quanto para adicionar ao carrinho, 
    // usando o index do array de pizza
